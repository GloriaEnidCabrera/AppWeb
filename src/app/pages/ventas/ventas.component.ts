...
export class VentasComponent implements OnInit {
  ...
  //Variable
  ciudad: number= 0;
  ciudadtexto=["Bogotá", "Medellín", "Cali"]
  consecutivo!: string;
  cantidad = [0, 0, 0];
  ...
  postconsolidado(): void{
    let cod= this.ventasPeticiones.postconsolidado(this.ciudad);
   cod.subscribe((response: any) => {
  ...
  showNotification(from: string, align: string, type: number) {
    switch (type) {
      ...
      case 10:
        ...
        break;
      case 11:
          this.toastr.success('Dato ingresadocon exito', '', {
            disableTimeOut: false,
            closeButton: true,
            enableHtml: true,
            positionClass: 'toast-' + from + '-' + align
          ...
          break;
      case 12:
        this.toastr.warning('Ciudad no seleccionada', '', {
          disableTimeOut: false,
          closeButton: true,
          enableHtml: true,
          positionClass: 'toast-' + from + '-' + align
