...
import com.Equipo7.mictic2022.tiendasgenericas.BackTiendaEquipo7.repository.ProductoRepository;
...
public class ProductoController {
	...
	@GetMapping("/productos/username/{username}")
	public ResponseEntity<List<Producto>> findByUsername(@PathVariable("username") String nombreproducto) {
		try {
